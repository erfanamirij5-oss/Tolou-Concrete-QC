...
import { IPC_CHANNELS, type AppInfo, type CreatePourInput, type CreateProjectInput, type CreateSeriesInput, type DraftResult, type HealthStatus, type IpcResult, type LaboratoryKind, type SaveDraftInput, type SeriesSummary, type CreateSeriesResult } from '../shared/ipc.js';

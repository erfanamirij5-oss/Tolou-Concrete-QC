...
type ReportWithOrganization=ProjectQcReport&{organization?:{qcManagerName?:string;managingDirectorName?:string}};
export function projectReportWorkbook(report:ProjectQcReport){
  const enriched=report as ReportWithOrganization;

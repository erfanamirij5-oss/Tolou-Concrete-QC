...
export function App(){
  ...
  const renderWorkspace=()=>{switch(activeView){
    ...
    case'reports':return <><section className="workspace-intro"><p className="eyebrow">خروجی‌های رسمی</p><h2>مرکز گزارش‌های کنترل کیفیت</h2><p>گزارش سریع یک نوبت نمونه‌برداری و گزارش جامع پروژه از داده‌های واقعی ثبت‌شده ساخته می‌شوند.</p></section><SamplingSeriesReportWorkbench refreshKey={dataVersion} initialProjectId={reportProjectId}/><ProjectQcReportWorkbench refreshKey={dataVersion}/></>;

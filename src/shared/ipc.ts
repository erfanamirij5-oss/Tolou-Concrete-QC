export const IPC_CHANNELS = {
  appInfo: 'tolou:app-info',
  health: 'tolou:health',
  createSeries: 'tolou:create-series',
  listSeries: 'tolou:list-series',
  saveDraft: 'tolou:save-draft',
  listSamples: 'tolou:list-samples',
  approveDraft: 'tolou:approve-draft',
  requestCorrection: 'tolou:request-correction',
  voidResult: 'tolou:void-result',
  reviewQueue: 'tolou:review-queue',
  resultHistory: 'tolou:result-history',
  scheduleWitness: 'tolou:schedule-witness',
  witnessScheduleHistory: 'tolou:witness-schedule-history',
  createProject: 'tolou:create-project',
  listProjects: 'tolou:list-projects',
  createPour: 'tolou:create-pour',
  listPours: 'tolou:list-pours',
  dashboard: 'tolou:dashboard',
  savePourContext: 'tolou:save-pour-context',
  getPourContext: 'tolou:get-pour-context',
  listPourContexts: 'tolou:list-pour-contexts',
  createMixDesign: 'tolou:create-mix-design',
  listMixDesigns: 'tolou:list-mix-designs',
  createMixVersion: 'tolou:create-mix-version',
  listMixVersions: 'tolou:list-mix-versions',
  savePourSpecification: 'tolou:save-pour-specification',
  getPourSpecification: 'tolou:get-pour-specification',
  createCustomer: 'tolou:create-customer',
  listCustomers: 'tolou:list-customers',
  createConcreteSource: 'tolou:create-concrete-source',
  listConcreteSources: 'tolou:list-concrete-sources',
  createTestingLaboratory: 'tolou:create-testing-laboratory',
  listTestingLaboratories: 'tolou:list-testing-laboratories',
  registerExternalResult: 'tolou:register-external-result',
  listExternalResults: 'tolou:list-external-results',
  listExternalAttachments: 'tolou:list-external-attachments',
  addExternalAttachment: 'tolou:add-external-attachment',
  saveSpecimenPhysics: 'tolou:save-specimen-physics',
  getSpecimenPhysics: 'tolou:get-specimen-physics',
  listSpecimenPhysics: 'tolou:list-specimen-physics',
  specimenPhysicsHistory: 'tolou:specimen-physics-history',
  saveFreshConcrete: 'tolou:save-fresh-concrete',
  getFreshConcrete: 'tolou:get-fresh-concrete',
  freshConcreteHistory: 'tolou:fresh-concrete-history',
  analyticsSummary: 'tolou:analytics-summary',
  projectQcReport: 'tolou:project-qc-report',
  exportProjectQcPdf: 'tolou:export-project-qc-pdf',
  exportProjectQcExcel: 'tolou:export-project-qc-excel',
} as const;
...
export type CustomerSummary = { id:string; name:string; archived:number };
export type CreateConcreteSourceInput = { id:string; name:string };
export type ConcreteSourceSummary = { id:string; name:string; archived:number };
export type CreateTestingLaboratoryInput = { id:string; name:string };
export type TestingLaboratorySummary = { id:string; name:string; archived:number };
export type SavePourContextInput = { pourId:string; customerId?:string|null; concreteSourceId?:string|null; notes?:string };
export type PourContextSummary = { pour_id:string; project_id:string; customer_id:string|null; concrete_source_id:string|null; notes:string|null; created_at:string; created_by:string; customer_name:string|null; concrete_source_name:string|null };
...
export type ExternalResultSummary = { id:string; sample_id:string; testing_laboratory_id:string; strength_mpa:number; tested_at:string; reference_no:string|null; entered_at:string; entered_by:string; testing_laboratory_name:string };
...
export type AnalyticsPoint = { at:string; value:number; label:string };
export type AnalyticsSeries = { metric:string; unit:string; count:number; mean:number|null; min:number|null; max:number|null; stdDev:number|null; points:AnalyticsPoint[] };

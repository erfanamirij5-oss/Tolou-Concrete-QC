CREATE TABLE pour_qc_contexts_c1_stage (
...
INSERT INTO pour_qc_contexts_c1_stage(pour_id,company_id,project_id,customer_id,concrete_source_id,created_at,created_by)
...
CREATE TABLE concrete_sources_c1 (
...
INSERT INTO concrete_sources_c1(id,company_id,code,name,source_type,archived)
SELECT id,company_id,code,name,source_type,archived
FROM concrete_sources;

DROP TABLE concrete_sources;
ALTER TABLE concrete_sources_c1 RENAME TO concrete_sources;
...
SELECT pour_id,company_id,project_id,customer_id,concrete_source_id,created_at,created_by
FROM pour_qc_contexts_c1_stage;

DROP TABLE pour_qc_contexts_c1_stage;
